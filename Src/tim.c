...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB8     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = TIM4_Slave_In_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(TIM4_Slave_In_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PA3     ------> TIM9_CH2
    */
    GPIO_InitStruct.Pin = TIM2_CCCV_Control_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM9;
    HAL_GPIO_Init(TIM2_CCCV_Control_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM11_MspPostInit 0 */
    ...
    PB9     ------> TIM11_CH1
    */
    GPIO_InitStruct.Pin = TIM4_Master_Out_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM11;
    HAL_GPIO_Init(TIM4_Master_Out_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB8     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(TIM4_Slave_In_GPIO_Port, TIM4_Slave_In_Pin);
...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim){
	...
	if(htim->Channel==HAL_TIM_ACTIVE_CHANNEL_3){
		...
		if (timer4_Update){
			priod_time=(TIM4->CCR3 &0xFFFF) -(priod_time_last - timer4_Update*(htim->Instance->ARR&0xFFFF));
		}else{
			priod_time=(TIM4->CCR3 &0xFFFF) -priod_time_last;
		}
		...
		uint16_t riseing_t0=TIM4->CCR3 &0xFFFF;
		uint16_t falling_t1=TIM4->CCR4 &0xFFFF;
		
		if (timer4_Update){
			duty_time=falling_t1 -(riseing_t0 -timer4_Update*(htim->Instance->ARR&0xFFFF));
		}else{
			duty_time=falling_t1 -riseing_t0;
		}
	}
