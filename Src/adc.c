...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC3     ------> ADC1_IN13
    */
    GPIO_InitStruct.Pin = Analog_IN_FeedBack_s_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Analog_IN_FeedBack_s_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN13
    */
    HAL_GPIO_DeInit(Analog_IN_FeedBack_s_GPIO_Port, Analog_IN_FeedBack_s_Pin);
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc){
	...
	for(int i=0;i<3;i++){
		ADC_RAW_Smooth[i]=(ADC_RAW_Smooth[i]*(1-Smooth_Factor))+ADC_RAW[i]*Smooth_Factor;
	}
	
	osSignalSet (ADC_TaskHandle,ADC_DRDY_signals);
	

}

void ADC_Process(void){
 	osSignalWait(ADC_DRDY_signals,osWaitForever );
